...
var params: any = {
  ...
  oauth_callback: encodeURIComponent(
    'https://dataviz.david-ma.net/smugmug-test.html',
  ),
...
params.oauth_signature = b64_hmac_sha1(
  `${consumer_secret}&${oauth_token}`,
  `${method}&${encodeURIComponent(REQUEST_TOKEN_URL)}&${normalized}`,
)
...
requestParams.oauth_signature = b64_hmac_sha1(
...
accessParams.oauth_signature = b64_hmac_sha1(
