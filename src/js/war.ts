...
drawPieChart = function () {
    ...
    warChart = new Chart({
        ...
        var data_ready = pie((<any>d3).entries(data).reverse())
        ...
        var innerData = pie
            .value((d:any) => d.value)
            ((<any>d3).entries(totals as object).reverse());
