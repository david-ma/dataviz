...
$.when($.ready).then(function () {
  const chart = new Chart({ // eslint-disable-line
    ...
    d3.csv("/dataviz/fistula.csv", function (row :RawFistulaDataPoint): FistulaDataPoint {
      ...
      var bottom = data.Continent[Math.floor(3 * length / 4)].YearsGained * ratio
      ...
      var bottom = data.Incontinent[Math.floor(3 * length / 4)].YearsGained * ratio
      var midpoint = chart.height / 2
      chart.svg.append('rect').attrs({
        x: chart.width * 0.4,
        width: chart.width * 0.05,
      ...
      var bottom = data.Partial[Math.floor(3 * length / 4)].YearsGained * ratio
      var midpoint = chart.height / 2
      chart.svg.append('rect').attrs({
        x: chart.width * 0.5,
        width: chart.width * 0.05,
      ...
      var bottom = data.Continent[Math.floor(3 * length / 4)].YearsLost * ratio
      var midpoint = chart.height / 2
      chart.svg.append('rect').attrs({
        x: chart.width * 0.3,
        width: chart.width * 0.05,
      ...
      var bottom = data.Incontinent[Math.floor(3 * length / 4)].YearsLost * ratio
      var midpoint = chart.height / 2
      chart.svg.append('rect').attrs({
        x: chart.width * 0.4,
        width: chart.width * 0.05,
