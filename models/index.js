...
exports.AwesomeProject.hasOne(exports.AwesomeMetadata, { foreignKey: 'awesome_project_id', sourceKey: 'id' });
exports.AwesomeMetadata.belongsTo(exports.AwesomeProject, { foreignKey: 'awesome_project_id', targetKey: 'id' });
exports.AwesomePhoto.belongsTo(exports.AwesomeProject, { foreignKey: 'awesome_project_id', targetKey: 'id' });
exports.AwesomeProject.hasMany(exports.AwesomePhoto, { foreignKey: 'awesome_project_id', sourceKey: 'id' });
